 ...
 * @version 1.0
 */
public class TravelingSalesmanRouteEvaluationFunction2 extends TravelingSalesmanEvaluationFunction {

    /**
     * Make a new route evaluation function
     * @param points the points of the cities
     */
    public TravelingSalesmanRouteEvaluationFunction2(double[][] points) {
        super(points);
    }
